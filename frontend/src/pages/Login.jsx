    ...
    <div className="login-wrapper">
      <div className="login-card glass-panel">
        <div className="login-header">
          <div style={{ display: 'inline-flex', padding: '16px', background: 'rgba(0, 210, 255, 0.08)', borderRadius: '12px', border: '1px solid rgba(0, 210, 255, 0.15)', marginBottom: '16px' }}>
        ...
        <form onSubmit={handleLogin}>
          <div className="input-group">
            ...
            <div style={{ position: 'relative' }}>
              <User size={18} style={{ position: 'absolute', left: '16px', top: '14px', color: 'var(--color-text-muted)' }} />
              <input 
                id="username"
                type="text" 
          ...
          <div className="input-group" style={{ marginBottom: '24px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <Lock size={18} style={{ position: 'absolute', left: '16px', top: '14px', color: 'var(--color-text-muted)' }} />
              <input 
                id="password"
              ...
              <button
                ...
                style={{ position: 'absolute', right: '16px', top: '14px', background: 'none', border: 'none', color: 'var(--color-text-muted)', cursor: 'pointer' }}
              >
